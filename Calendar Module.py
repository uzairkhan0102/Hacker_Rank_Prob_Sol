...
calen = sys.stdin.readline()
month,day,year = calen[0:2],calen[3:5],calen[6:]
ans =calendar.weekday(int(year),int(month),int(day))
#print (calendar.day_name(calen))
#day = calendar.TextCalendar(firstweekday=6).formatyear(c)
day = calendar.day_name[ans].capitalize()
print(day.upper())
