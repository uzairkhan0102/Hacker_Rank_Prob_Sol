...
When printed, iterated or converted into a sequence, its elements
will appear in an arbitrary order.
...
Here, set ([154,161,167,170,171174,176,182]) is the set containing the distinct heights.
