...
groupby() function of itertools . To read more about this function,
Check this out .
...
First, the character  occurs only once. It is replaced by .
Then the character  occurs three times, and it is replaced by  and so on.
